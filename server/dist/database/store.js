...
exports.db = void 0;
exports.calculateSkillScore = calculateSkillScore;
function calculateSkillScore(completedJobs, averageRating, onTimePercentage) {
    ...
    seed() {
        ...
        const rawWorkers = [
            {
                ...
                onTime: 94.0,
                skills: [
                    { skillId: 'sk-elec', name: 'Electrician', experienceYears: 7, skillLevel: 'GOLD' },
                    { skillId: 'sk-ac', name: 'AC Technician', experienceYears: 4, skillLevel: 'GOLD' }
                ],
                startingPrice: 299,
            ...
            },
            {
                ...
                onTime: 96.5,
                skills: [
                    { skillId: 'sk-plumb', name: 'Plumber', experienceYears: 6, skillLevel: 'GOLD' },
                    { skillId: 'sk-clean', name: 'Cleaner', experienceYears: 3, skillLevel: 'SILVER' }
                ],
                startingPrice: 249,
            ...
            },
            {
                ...
                onTime: 91.0,
                skills: [
                    { skillId: 'sk-carp', name: 'Carpenter', experienceYears: 9, skillLevel: 'GOLD' }
                ],
                startingPrice: 349,
            ...
            },
            {
                ...
                onTime: 93.0,
                skills: [
                    { skillId: 'sk-paint', name: 'Painter', experienceYears: 5, skillLevel: 'GOLD' }
                ],
                startingPrice: 499,
            ...
            },
            {
                ...
                onTime: 92.5,
                skills: [
                    { skillId: 'sk-clean', name: 'Cleaner', experienceYears: 4, skillLevel: 'GOLD' },
                    { skillId: 'sk-dom', name: 'Domestic Helper', experienceYears: 2, skillLevel: 'SILVER' }
                ],
                startingPrice: 399,
            ...
            },
            {
                ...
                onTime: 97.0,
                skills: [
                    { skillId: 'sk-gard', name: 'Gardener', experienceYears: 8, skillLevel: 'GOLD' }
                ],
                startingPrice: 249,
            ...
            },
            {
                ...
                onTime: 98.0,
                skills: [
                    { skillId: 'sk-driv', name: 'Driver', experienceYears: 11, skillLevel: 'MASTER' }
                ],
                startingPrice: 450,
            ...
            },
            {
                ...
                onTime: 99.0,
                skills: [
                    { skillId: 'sk-care', name: 'Caregiver', experienceYears: 6, skillLevel: 'GOLD' }
                ],
                startingPrice: 599,
            ...
            },
            {
                ...
                onTime: 93.0,
                skills: [
                    { skillId: 'sk-ac', name: 'AC Technician', experienceYears: 7, skillLevel: 'GOLD' },
                    { skillId: 'sk-app', name: 'Appliance Repair', experienceYears: 5, skillLevel: 'GOLD' }
                ],
                startingPrice: 499,
            ...
            },
            {
                ...
                onTime: 89.0,
                skills: [
                    { skillId: 'sk-dom', name: 'Domestic Helper', experienceYears: 4, skillLevel: 'SILVER' },
                    { skillId: 'sk-clean', name: 'Cleaner', experienceYears: 2, skillLevel: 'BRONZE' }
                ],
                startingPrice: 299,
            ...
            // 11 to 20
            {
                ...
                jobs: 72,
                onTime: 92.0,
                skills: [{ skillId: 'sk-elec', name: 'Electrician', experienceYears: 5, skillLevel: 'GOLD' }],
                startingPrice: 299,
            ...
            },
            {
                ...
                jobs: 85,
                onTime: 95.0,
                skills: [{ skillId: 'sk-plumb', name: 'Plumber', experienceYears: 8, skillLevel: 'GOLD' }],
                startingPrice: 249,
            ...
            },
            {
                ...
                jobs: 60,
                onTime: 94.0,
                skills: [{ skillId: 'sk-tech', name: 'General Technician', experienceYears: 4, skillLevel: 'GOLD' }],
                startingPrice: 350,
            ...
            },
            {
                ...
                jobs: 42,
                onTime: 90.0,
                skills: [{ skillId: 'sk-carp', name: 'Carpenter', experienceYears: 6, skillLevel: 'SILVER' }],
                startingPrice: 349,
            ...
            },
            {
                ...
                jobs: 53,
                onTime: 91.5,
                skills: [{ skillId: 'sk-app', name: 'Appliance Repair', experienceYears: 5, skillLevel: 'GOLD' }],
                startingPrice: 399,
            ...
            },
            {
                ...
                jobs: 77,
                onTime: 96.0,
                skills: [{ skillId: 'sk-clean', name: 'Cleaner', experienceYears: 5, skillLevel: 'GOLD' }],
                startingPrice: 399,
            ...
            },
            {
                ...
                jobs: 38,
                onTime: 88.0,
                skills: [{ skillId: 'sk-paint', name: 'Painter', experienceYears: 4, skillLevel: 'SILVER' }],
                startingPrice: 499,
            ...
            },
            {
                ...
                jobs: 67,
                onTime: 98.5,
                skills: [{ skillId: 'sk-care', name: 'Caregiver', experienceYears: 7, skillLevel: 'GOLD' }],
                startingPrice: 599,
            ...
            },
            {
                ...
                jobs: 59,
                onTime: 92.0,
                skills: [{ skillId: 'sk-driv', name: 'Driver', experienceYears: 5, skillLevel: 'SILVER' }],
                startingPrice: 450,
            ...
            },
            {
                ...
                jobs: 22,
                onTime: 86.0,
                skills: [{ skillId: 'sk-elec', name: 'Electrician', experienceYears: 3, skillLevel: 'SILVER' }],
                startingPrice: 299,
        ...
        for (let day = 30; day >= 1; day--) {
            ...
            baseServices.forEach(srv => {
                zones.forEach(zn => {
                    let baseReq = 12;
                    if (srv === 'Plumber' || srv === 'Electrician')
                        baseReq = 26;
                    if (srv === 'AC Technician')
                        baseReq = 22;
                    if (zn === 'Central Varanasi')
                        baseReq += 8;
